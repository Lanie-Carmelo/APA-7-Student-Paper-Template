...
VERSION_TEX = version.tex

# Create submissions directory
submissions-dir:
	mkdir -p $(SUBMISSIONS_DIR)

# Generate version.tex from VERSION file
# This target automatically creates version.tex from the VERSION file.
# The version date is set to the current date at build time.
# version.tex is excluded from git tracking and regenerated on each build.
$(VERSION_TEX): $(VERSION_FILE)
	@echo "% version.tex - Auto-generated version information" > $(VERSION_TEX)
	@echo "% This file is automatically generated from VERSION file" >> $(VERSION_TEX)
	@echo "% DO NOT EDIT THIS FILE MANUALLY - Update VERSION file instead" >> $(VERSION_TEX)
	@printf "\\\\newcommand{\\\\templateversion}{%s}\n" "$$(cat $(VERSION_FILE))" >> $(VERSION_TEX)
	@printf "\\\\newcommand{\\\\templatedate}{%s}\n" "$$(date +%Y-%m-%d)" >> $(VERSION_TEX)
	@echo "✅ Generated $(VERSION_TEX) from $(VERSION_FILE)"

# Default target
all: pdf html docx

# PDF target
pdf: $(VERSION_TEX) | $(OUTPUT_DIR)
...
pdf-pandoc: $(VERSION_TEX) | $(OUTPUT_DIR)
	pandoc $(TEXFILE) \
		--pdf-engine=lualatex \
...
html: $(VERSION_TEX) $(TEXFILE) $(BIBFILE) | $(OUTPUT_DIR)
	pandoc $(TEXFILE) \
		--from latex \
		--to html \
		--standalone \
...
docx: $(VERSION_TEX) $(TEXFILE) $(BIBFILE) | $(OUTPUT_DIR)
	pandoc $(TEXFILE) \
...
# Clean version.tex (auto-generated file)
clean-version:
	rm -f $(VERSION_TEX)
	@echo "✅ Removed auto-generated $(VERSION_TEX)"

# Distclean target to remove all generated files
distclean: clean clean-version
...
help:
	...
	@echo "  clean-version- Remove auto-generated version.tex"
	@echo "  distclean    - Remove all generated files (including version.tex)"
	@echo "  help         - Show this help message"

# Phony targets
.PHONY: all pdf pdf-pandoc html docx clean clean-version distclean check view refresh lint build submissions submissions-dir status help watch
