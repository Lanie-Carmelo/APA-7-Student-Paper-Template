...
### Changed
- Version tracking now uses automated generation from VERSION file
  - `version.tex` is now auto-generated by Makefile from VERSION file
  - Version date is automatically set to current date during build
  - Eliminates manual version number duplication between VERSION and version.tex files
  - Added `clean-version` target to remove auto-generated version.tex
  - Updated .gitignore to exclude auto-generated version.tex
